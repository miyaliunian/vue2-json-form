...
!(function () {
  ...
  const o = (t) => t && /^(TH|TD)$/.test(t.nodeName),
    a = (t, e) => (r) => {
      const s = (s) => {
        r.setActive(
          ((t, e, r) => {
  ...
  t.add("advlist", (t) => {
    t.hasPlugin("lists")
      ? (((t) => {
        ...
        ((t) => {
          u(t, "numlist", "Numbered list", "InsertOrderedList", "OL", s(t)),
            u(t, "bullist", "Bullet list", "InsertUnorderedList", "UL", n(t))
        })(t),
        ((t) => {
