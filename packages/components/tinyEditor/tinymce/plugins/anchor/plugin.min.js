...
!(function () {
  ...
  const a = "a:not([href])",
    ...
    l = (e) =>
      ((e) => e && "a" === e.nodeName.toLowerCase())(e) &&
      !e.getAttribute("href") &&
      "" !== i(e),
              ...
              o(e) || e.selection.collapse(!0),
                e.selection.isCollapsed()
                  ...
                  : (((e) => {
                    ...
                    e.formatter.remove("namedAnchor", null, null, !0),
    ...
    d = (e) =>
      ((e) => e && r(e.attr("href")) && !r(e.attr("id") || e.attr("name")))(
        e
      ) && !e.firstChild,
    m = (e) => (t) => {
      for (let n = 0; n < t.length; n++) {
        const o = t[n]
        d(o) && o.attr("contenteditable", e)
      }
    }
  e.add("anchor", (e) => {
    ;((e) => {
      ...
      ((e) => {
        e.ui.registry.addToggleButton("anchor", {
          icon: "bookmark",
          tooltip: "Anchor",
          onAction: () => e.execCommand("mceAnchor"),
          onSetup: (t) =>
