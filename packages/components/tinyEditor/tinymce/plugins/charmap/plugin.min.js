...
!(function () {
  ...
  const t = (e, t) => {
      const a = ((e, t) => e.dispatch("insertCustomChar", { chr: t }))(e, t).chr
      ...
      (e) =>
        ...
        ((e) => {
          ...
          return null === e
            ...
            : "object" === t &&
              ((a = r = e),
              (n = String).prototype.isPrototypeOf(a) ||
  ...
  const u = (e) => (t) => t.options.get(e),
    ...
    f = (e) => {
      const t = ((e, t) => {
        const a = g(e)
        a && (t = [{ name: p, characters: d(a) }])
        const r = h(e)
        if (r) {
          const e = c.grep(t, (e) => e.name === p)
          return e.length
            ? ((e[0].characters = [].concat(e[0].characters).concat(d(r))), t)
            : t.concat({ name: p, characters: d(r) })
        }
        return t
      })(e, [
        {
    ...
    v = (e, t) => {
      ...
      return (
        ...
        l(a, (e) => ({ text: e[1], value: b(e[0]), icon: b(e[0]) }))
      )
    },
    k = "pattern",
    C = (e, a) => {
      const n = () => [
          { label: "Search", type: "input", name: k },
        ...
        u = {
          ...
          initialData: { pattern: "", results: v(a[0], "") },
          onAction: (a, r) => {
    ...
    return (
      ...
      ((e) => {
        e.ui.registry.addButton("charmap", {
          ...
          onAction: () => e.execCommand("mceShowCharmap")
        }),
