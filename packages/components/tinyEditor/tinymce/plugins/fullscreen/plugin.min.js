...
!(function () {
  ...
  const v = (t) => {
    ...
    F = Object.keys,
    O = (e, t) => -1 !== e.indexOf(t),
    T = (e) => void 0 !== e.style && c(e.style.getPropertyValue),
    k = (e) => {
  ...
  const A = (e) => (t) => ((e) => e.dom.nodeType)(t) === e,
    R = A(1),
    L = A(3),
    M = A(9),
    N = A(11),
    ...
    D = (e) => C(e.dom.ownerDocument),
    W = (e) => b(e.dom.childNodes, C),
    q = c(Element.prototype.attachShadow) && c(Node.prototype.getRootNode),
    H = m(q),
    I = q ? (e) => C(e.dom.getRootNode()) : (e) => (M(e) ? e : D(e)),
    B = (e) => {
      const t = I(e)
    ...
    V = (e) => C(e.dom.host),
    _ = (e) => {
      const t = L(e) ? e.dom.parentNode : e.dom
    ...
    U = (e) => {
      const t = C(
          ((e) => {
            if (H() && a(e.target)) {
              const t = C(e.target)
              if (R(t) && a(t.dom.shadowRoot) && e.composed && e.composedPath) {
                const t = e.composedPath()
                if (t)
                  return ((e, t) => (0 < e.length ? f.some(e[0]) : f.none()))(t)
              }
            }
    ...
    Y = (e, t, n) =>
      ((e, t, n, r) =>
        ((e, t, n, r, o) => {
          ...
          return e.dom.addEventListener(t, s, o), { unbind: h(K, e, t, s, o) }
        })(e, t, n, r, !1))(e, t, X, n),
    G = () => J(0, 0),
    J = (e, t) => ({ major: e, minor: t }),
    Q = {
      nu: J,
      detect: (e, t) => {
    ...
    ne = [
      ...
      },
      {
        ...
        search: (e) =>
          (O(e, "safari") || O(e, "mobile/")) && O(e, "applewebkit")
      }
    ],
    re = [
      {
    ...
    de = () => ue({ current: void 0, version: Q.unknown() }),
    me = ue,
    ...
    Se = () => be({ current: void 0, version: Q.unknown() }),
    xe = be,
    Ee =
      (m(he),
      m("iOS"),
        ...
        const r = oe.browsers(),
          ...
          s = t
            ...
            .orThunk(() =>
              ((e, t) =>
                Z(e, t).map((e) => {
                  const n = Q.detect(e.versionRegexes, t)
    ...
    Fe = (e) => window.matchMedia(e).matches
  let Oe = ((e) => {
    let t,
      n = !1
    return (...r) => (n || ((n = !0), (t = e.apply(null, r))), t)
  })(() => Ee(navigator.userAgent, f.from(navigator.userAgentData), Fe))
  const Te = (e, t) => ({
      left: e,
      top: t,
      translate: (n, r) => Te(e + n, t + r)
    }),
    ke = Te,
    Ce = (e) => {
  ...
  const Pe = (e, t) => {
    ...
    De = ("fullscreen_native", (e) => e.options.get("fullscreen_native"))
  const We = (e) => {
      return (
        e.dom ===
        (void 0 !== (t = D(e).dom).fullscreenElement
          ? t.fullscreenElement
    ...
    He = (e, t) =>
      ((e, n) => {
        return x(
          ((e) => f.from(e.dom.parentNode).map(C))((r = e))
            .map(W)
            .map((e) =>
              x(e, (e) => {
    ...
    je = (e) => {
      const t = ((e, t) => {
        ...
        return "" !== r || _(e)
          ? r
          : ((e, t) => (T(e) ? e.style.getPropertyValue(t) : ""))(n, t)
      })(e, "background-color")
      return void 0 !== t && "" !== t
      ...
      (e) => {
        ...
        return {
          bind: (e) => {
            t.set(e),
              o.throttle(),
              n.set(Le("resize", o.throttle)),
              r.set(Le("scroll", o.throttle))
          },
          unbind: () => {
            t.on(() => {
              n.clear(), r.clear()
            ...
            ((e) => {
              const t = ((e, t) => {
                ...
                return (1 !== (r = n).nodeType &&
                  ...
                  ? []
                  : b(n.querySelectorAll(e), C)
                var r
              })("[" + Ie + "]")
              S(t, (t) => {
                const n = j(t, Ie)
                "no-styles" !== n ? $(t, e.parseStyle(n)) : z(t, "style"),
                  z(t, Ie)
              })
            })(e.dom),
            v(ze.removeClass),
            $e.unbind(),
            f.from(t.get()).each((e) => e.fullscreenChangeHandler.unbind())
        }
      if (d)
        d.fullscreenChangeHandler.unbind(),
          De(e) &&
            We(c) &&
            ((e) => {
              const t = e.dom
          ...
          (p.width = d.iframeWidth),
          (p.height = d.iframeHeight),
          (g.width = d.containerWidth),
          (g.height = d.containerHeight),
          (g.top = d.containerTop),
          (g.left = d.containerLeft),
          w(),
          (x = d.scrollPos),
          window.scrollTo(x.x, x.y),
          t.set(null),
          Pe(e, !1),
          e.off("remove", w)
      else {
          ...
          ((e, t, n) => {
            const r = (t) => (n) => {
              ...
              a = ((e) => {
                ...
                return t
              })(b(i, (e) => He(e, "*:not(.tox-silver-sink)"))),
              c = je(n)
            S(a, r("display:none!important;")),
              S(i, r(Be + Ve + c)),
              r((!0 === _e ? "" : Be) + Ve + c)(t)
          })(e.dom, a, m),
