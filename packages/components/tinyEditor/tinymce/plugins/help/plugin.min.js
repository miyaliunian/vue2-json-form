...
!(function () {
  ...
  const d = (e) => {
      const t = p.os.isMacOS() || p.os.isiOS(),
        n = t
          ? {
              alt: "&#x2325;",
              ctrl: "&#x2303;",
      ...
      items: [
        {
          ...
          cells: l(g, (e) => {
            const t = l(e.shortcuts, d).join(" or ")
            return [e.action, t]
          })
        }
      ]
        ...
        h = {
          ...
          html: [
            ((e) =>
              null == e
                ? ""
                : '<div data-mce-tabstop="1" tabindex="-1">' + n(e) + "</div>")(
              e
            ),
            (() => {
              const e = c(
                  k,
                  ({ key: e, type: t }) =>
                    "autocorrect" !== e && "premium" === t
                ),
                t = l(e, (e) => "<li>" + b.translate(e.name) + "</li>").join("")
              return (
                ...
                b.translate("Learn more...") +
                "</a></li></ul></div>"
              )
            })()
          ].join("")
        }
      return { name: "plugins", title: "Plugins", items: [h] }
    }
  var f = tinymce.util.Tools.resolve("tinymce.EditorManager")
  const w = (e, t) => () => {
    const { tabs: a, names: o } = ((e, t) => {
        const a = y(),
          o = {
            name: "keyboardnav",
          ...
          c = { [a.name]: a, [o.name]: o, [i.name]: i, [s.name]: s, ...t.get() }
        return r.from(n(e)).fold(
          () =>
            ((e) => {
              const t = u(e),
