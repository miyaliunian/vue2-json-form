...
!(function () {
  ...
  const t = (e) => (t) => t.options.get(e),
    ...
    c = (e, t) => {
      if ((e = "" + e).length < t)
        for (let r = 0; r < t - e.length; r++) e = "0" + e
      return e
    },
    d = (e, t, r = new Date()) =>
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
        ...
        "%Y",
        "" + r.getFullYear()
      )).replace("%y", "" + r.getYear())).replace(
        "%m",
        c(r.getMonth() + 1, 2)
      )).replace("%d", c(r.getDate(), 2))).replace(
        "%H",
        "" + c(r.getHours(), 2)
      )).replace("%M", "" + c(r.getMinutes(), 2))).replace(
        "%S",
        "" + c(r.getSeconds(), 2)
      )).replace("%I", "" + (((r.getHours() + 11) % 12) + 1))).replace(
        "%p",
        r.getHours() < 12 ? "AM" : "PM"
      )).replace("%B", "" + e.translate(m[r.getMonth()]))).replace(
        "%b",
        "" + e.translate(l[r.getMonth()])
      )).replace("%A", "" + e.translate(o[r.getDay()]))).replace(
        "%a",
        "" + e.translate(i[r.getDay()])
      )).replace("%%", "%"),
    u = (e, t) => {
      if (s(e)) {
        const r = d(e, t)
        ...
        n
          ? ((e, t, r, a) => {
              const n = e.dom.create("time", { datetime: r }, a)
              t.parentNode.insertBefore(n, t),
                e.dom.remove(t),
                e.selection.select(n, !0),
                e.selection.collapse(!1)
            })(e, n, a, r)
          : e.insertContent('<time datetime="' + a + '">' + r + "</time>")
    ...
    ;((e) => {
      ...
      ((e) => {
        e.addCommand("mceInsertDate", (t, a) => {
          ...
          e.addCommand("mceInsertTime", (t, r) => {
            u(e, null != r ? r : a(e))
          })
      })(e),
      ((e) => {
