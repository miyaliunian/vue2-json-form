  ...
  const F = (e, t = {}) =>
    ...
    U = (e, t) => {
      const r = t.attr("style"),
        a = r ? N.parseStyle(r) : {}
      ;(a["max-width"] = R(e.width)),
        (a["max-height"] = R(e.height)),
    ...
    B = (e, t) => {
      ...
      r.altsource || (r.altsource = ""),
        ...
        (r.sourcemime = $(r.source)),
        (r.altsourcemime = $(r.altsource)),
      ...
      if (
        (a &&
          ((r.source = a.url),
          (r.type = a.type),
          (r.allowfullscreen = a.allowFullscreen),
          (r.width = r.width || String(a.w)),
          (r.height = r.height || String(a.h))),
        r.embed)
      )
        return E(r.embed, r, !0, e.schema)
      {
        const t = g(e),
          a = b(e),
          o = w(e)
            ...
            ? ((e, t) =>
                t
                  ...
                  : '<audio controls="controls" src="' +
                    ...
                    "</audio>")(r, t)
            : "script" === r.type
            ? ((e) => '<script src="' + e.source + '"></script>')(r)
            : ((e, t) =>
                t
                  ? t(e)
                  : '<video width="' +
      ...
      const r = t
        ...
        o = ((e, t, r) => (o) => {
          ...
          return {
            [o]: (o === r
              ? s().bind((e) =>
                  a(e) ? n(e).orThunk(c) : c().orThunk(() => i.from(e))
                )
              : c().orThunk(() => s().bind((e) => (a(e) ? n(e) : i.from(e))))
            ).getOr("")
          }
        })(e, r, t)
      return {
    ...
    X = (e, t) => (a) => {
      if (r(a.url) && a.url.trim().length > 0) {
        const r = a.html,
          o = { ...C(r, t.schema), source: a.url, embed: r }
        e.setData(Q(o))
      }
    },
    Y = (e, t) => {
    ...
    Z = (e) => {
      ...
      const c = { title: "Advanced", name: "advanced", items: i },
        n = [
          s,
          {
            title: "Embed",
      ...
      const m = { type: "tabpanel", tabs: n },
        u = e.windowManager.open({
          ...
          onSubmit: (t) => {
            ...
            ;((e, t, r) => {
              var a
              ;(t.embed = E(t.embed, t, !1, r.schema)),
                t.embed && (e.source === t.source || ((a = t.source), h(W, a)))
                  ? Y(r, t.embed)
                  : H(r, t)
                      .then((e) => {
                        Y(r, e.html)
  ...
  const te = (e) => {
    ...
    se = (e, t) => {
      ...
      a.attr({
        ...
        ie(e, t, a)
      const o = e.dom.parseStyle(t.attr("style")),
        i = new z(r, 1)
      if (
        (ae(t, i, o),
        i.attr({
    ...
    ie = (e, t, r) => {
      ...
      for (; o--; ) {
        ...
        "width" === t ||
          ...
          "style" === t ||
          ((i = "data-mce-"),
          (s = t).length >= i.length && s.substr(0, 0 + i.length) === i) ||
          (("data" !== t && "src" !== t) || (c = e.convertURL(c, t)),
          r.attr("data-mce-p-" + t, c))
      }
      var s, i
      const c = M({ inner: !0 }, e.schema),
        l = new z("div", 1)
      n(t.children(), (e) => l.append(e))
      const m = c.serialize(l)
      ...
      ((e) => {
        e.on("PreInit", () => {
          const { schema: t, serializer: r, parser: a } = e,
            o = t.getBoolAttrs()
          n("webkitallowfullscreen mozallowfullscreen".split(" "), (e) => {
            o[e] = {}
          }),
            ((e, t) => {
              const r = m(e)
                  ...
                  (r = t[a]),
                    r.parent &&
                      (r.parent.attr("data-mce-object") ||
                        (te(r) && y(e)
                          ? ne(r) || r.replace(se(e, r))
                          : ne(r) || r.replace(oe(e, r))))
              })(e)
            ),
            r.addAttributeFilter("data-mce-object", (t, r) => {
              ...
              for (; a--; ) {
                ...
                const s = o.attr(r),
                  i = new z(s, 1)
                if ("audio" !== s && "script" !== s) {
                  const e = o.attr("class")
                  e && -1 !== e.indexOf("mce-preview-object")
                    ? i.attr({
                ...
                i.attr({ style: o.attr("style") })
                const c = o.attributes
                let l = c.length
                for (; l--; ) {
                  const e = c[l].name
                  0 === e.indexOf("data-mce-p-") &&
                    i.attr(e.substr(11), c[l].value)
                }
                "script" === s && i.attr("type", "text/javascript")
                const m = o.attr("data-mce-html")
                if (m) {
                  const t = le(e, s, unescape(m))
                  n(t.children(), (e) => i.append(e))
                }
                o.replace(i)
              }
            })
          ...
          e.on("SetContent", () => {
            const t = e.dom
            n(t.select("span.mce-preview-object"), (e) => {
