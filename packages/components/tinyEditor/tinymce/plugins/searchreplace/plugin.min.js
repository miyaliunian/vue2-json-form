...
!(function () {
  ...
  const N = (e) => {
    ...
    k = N,
    T = (e, t) => ({ element: e, offset: t }),
    A = (e, t) => {
      ;((e, t) => {
        const n = ((e) => m.from(e.dom.parentNode).map(k))(e)
        n.each((n) => {
  ...
  const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
    ...
    P = (e, t) =>
      ((e, t) => {
        const n = ((e) => y(e.dom.childNodes, k))(e)
    ...
    W = (e, t, n, o, r) => {
      if (
        ...
        return
      const s = e.getParent(o, e.isBlock),
        a = new F(n, s),
    ...
    ee = (e, t, n, o, r) => {
      ...
      for (let t = 0; t < d.length; t++) {
        ...
        if (r || u === s.index) {
          for (
            n.length
              ? ((d[t].firstChild.nodeValue = n), K(d[t]))
              : L(e.dom, d[t]);
            d[++t];
