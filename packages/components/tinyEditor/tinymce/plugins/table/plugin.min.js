...
!(function () {
  ...
  const Et = (e, t, o, l) => {
    ...
    Uo = (e, t, o, n) => {
      if ("TD" === t.tagName || "TH" === t.tagName)
        l(o) ? e.setStyle(t, o, n) : e.setStyles(t, o)
      else if (t.children)
        for (let l = 0; l < t.children.length; l++) Uo(e, t.children[l], o, n)
    },
    Go = (e, t, o, l) => {
      const n = e.dom,
        r = l.getData(),
      ...
      l.close(),
        ...
        e.undoManager.transact(() => {
          if (!t) {
            const o = parseInt(r.cols, 10) || 1,
              l = parseInt(r.rows, 10) || 1
          ...
          if (v(a) > 0) {
            ;((e, t, o) => {
              ...
              if (
                ...
                ut(e)
                  ? ((r["border-width"] = xt(o.border)),
                    (r["border-spacing"] = xt(o.cellspacing)))
                  : ((n.border = o.border),
                ...
                for (let n = 0; n < t.children.length; n++)
                  Uo(l, t.children[n], {
                    ...
                    it(e) &&
                      Uo(l, t.children[n], { "border-color": o.bordercolor })
              it(e) &&
                ((r["background-color"] = o.backgroundcolor),
                (r["border-color"] = o.bordercolor),
                (r["border-style"] = o.borderstyle)),
                (n.style = l.serializeStyle({ ...Ct(e), ...r })),
                l.setAttribs(t, { ...vt(e), ...n })
            })(e, t, r)
    ...
    Ko = (e, t) => {
                ...
                const l = e.dom,
                  n = ut(e)
                    ...
                    : l.getAttrib(t, "cellspacing") ||
                      l.getStyle(t, "border-spacing"),
                  r = ut(e)
                    ? Ge(l, t, "padding") || l.getAttrib(t, "cellpadding")
                    : l.getAttrib(t, "cellpadding") || Ge(l, t, "padding")
                return {
                  ...
                  cellpadding: r,
                  border: ((t, o) => {
                    const l = Oe(j.fromDom(o), "border-width")
                    return ut(e) && l.isSome()
                      ? l.getOr("")
                      : t.getAttrib(o, "border") ||
                          Ge(e.dom, o, "border-width") ||
                          Ge(e.dom, o, "border")
                  })(l, t),
      ...
      const a = { type: "grid", columns: 2, items: $o(e, r, t) },
        s = it(e)
          ? {
              type: "tabpanel",
              tabs: [
    ...
    Qo = (e) => {
      ...
      return e.length > 0 && F(e, (e) => t(e, "rowspan") || t(e, "colspan"))
        ? f.some(e)
        : f.none()
    },
    Xo = (e, t, o) => {
        ...
        a = () =>
          Wt(At(e), Tt(e)).bind((t) => {
            return (
              (o = Se(
                Be(t),
                Wt(((e) => j.fromDom(e.selection.getEnd()))(e), Tt(e)).bind(Be),
                (o, l) =>
                  Y(o, l)
                    ? n(t)
                      ? f.some(
      ...
      return (
        e.on("NodeChange ExecCommand TableSelectorChange", c),
        {
          ...
          onSetupTableWithCaption: (t) =>
            d(t, g, (t) =>
              Be(t.element, Tt(e)).exists((e) => ue(e, "caption").isSome())
            ),
  ...
  const el = (e) => {
      var t
      const o = null !== (t = Zo.read()) && void 0 !== t ? t : []
      return L(o, (t) => f.from(t.getType(e)))
    },
    tl = () => el("x-tinymce/dom-table-rows"),
    ol = () => el("x-tinymce/dom-table-columns")
  e.add("table", (e) => {
    const t = Yo(e)
    ;((e) => {
      const t = e.options.register
      t("table_border_widths", { processor: "object[]", default: Ze }),
        t("table_border_styles", { processor: "object[]", default: et }),
        ...
        0 !== u.length &&
          ...
          e.queryCommandSupported("mceTableApplyCellStyle") &&
            (e.ui.registry.addNestedMenuItem("tablecellvalign", {
              ...
              text: "Vertical align",
              getSubmenuItems: () =>
                io(e, Kt, "tablecellverticalalign", mo(e, "vertical-align")),
              onSetup: t.onSetupCellOrRow
            }),
            e.ui.registry.addNestedMenuItem("tablecellborderwidth", {
              ...
              text: "Border width",
              getSubmenuItems: () =>
                io(e, rt(e), "tablecellborderwidth", mo(e, "border-width")),
              onSetup: t.onSetupCellOrRow
            }),
            e.ui.registry.addNestedMenuItem("tablecellborderstyle", {
              ...
              text: "Border style",
              getSubmenuItems: () =>
                io(e, at(e), "tablecellborderstyle", mo(e, "border-style")),
              onSetup: t.onSetupCellOrRow
            }),
            e.ui.registry.addNestedMenuItem("tablecellbackgroundcolor", {
              icon: "cell-background-color",
              text: "Background color",
              getSubmenuItems: () => bo(e, ft(e), "background-color"),
              onSetup: t.onSetupCellOrRow
            }),
            e.ui.registry.addNestedMenuItem("tablecellbordercolor", {
              icon: "cell-border-color",
              text: "Border color",
              getSubmenuItems: () => bo(e, yt(e), "border-color"),
              onSetup: t.onSetupCellOrRow
            })),
          n("tablecaption", {
            icon: "table-caption",
        ...
        0 !== a.length &&
          ...
          e.queryCommandSupported("mceTableApplyCellStyle") &&
            ...
            e.ui.registry.addMenuButton("tablecellbackgroundcolor", {
              ...
              fetch: (t) => t(bo(e, ft(e), "background-color")),
              onSetup: t.onSetupCellOrRow
            }),
            e.ui.registry.addMenuButton("tablecellbordercolor", {
              icon: "cell-border-color",
              tooltip: "Border color",
              fetch: (t) => t(bo(e, yt(e), "border-color")),
              onSetup: t.onSetupCellOrRow
            })),
          n("tablecaption", {
